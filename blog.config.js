...
const BLOG = {
  API_BASE_URL: process.env.API_BASE_URL || 'https://yanachan.notion.site/api/v3', // API默认请求地址,可以配置成自己的地址例如：https://[xxxxx].notion.site/api/v3
  ...
  NEST: process.env.NEXT_PUBLIC_NEST || true, // 彩带开关
  // 樱花飘落特效

...
module.exports = {
  ...
  MUSIC_PLAYER_AUDIO_LIST: [
    // 示例音乐列表。除了以下配置外，还可配置歌词，具体配置项看此文档 https://aplayer.js.org/#/zh-Hans/
    {
      name: '「一夜橋」',
      artist: '増田俊郎',
      url: 'https://music.163.com/song/media/outer/url?id=469899.mp3',
      cover:
        'https://p1.music.126.net/q9RlYhmIAIMsfhsihCjDFQ==/2479398720652190.jpg'
    },
    {
      name: '「籠のなか」',
      artist: '増田俊郎',
      url: 'https://music.163.com/song/media/outer/url?id=30431614.mp3',
      cover:
        'https://p1.music.126.net/AYCiuTZAVP4Hf6FTHCc4mA==/109951169591372418.jpg'
    }
  ],
